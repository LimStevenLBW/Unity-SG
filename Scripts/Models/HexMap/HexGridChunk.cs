...
public class HexGridChunk : MonoBehaviour
{
    ...
    void TriangulateWithRiver(HexDirection direction, HexCell cell, Vector3 center, EdgeVertices e)
    {
        ...
        center = Vector3.Lerp(centerL, centerR, 0.5f); //Determine the final center
    ...
    /*Creates the bridge quads between hexcells*/
    ...
    void TriangulateCorner(Vector3 bottom, HexCell bottomCell, Vector3 left, HexCell leftCell, Vector3 right, HexCell rightCell)
    {
        ...
        if (leftEdgeType == HexEdgeType.Slope)
        {
            ...
            else if (rightEdgeType == HexEdgeType.Flat) //Dual-slope Variants
            {
                TriangulateCornerTerraces(
        ...
        else if (rightEdgeType == HexEdgeType.Slope) //Dual-slope Variants
        {
    ...
    //Version that only accepts one height for convenience
