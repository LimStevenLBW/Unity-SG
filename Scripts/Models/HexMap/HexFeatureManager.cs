...
public class HexFeatureManager : MonoBehaviour
{
    ...
    public void AddWall(EdgeVertices near, HexCell nearCell, EdgeVertices far, HexCell farCell, bool hasRiver, bool hasRoad)
    {
        if (nearCell.Walled != farCell.Walled &&
            !nearCell.IsUnderwater && //not underwater or on cliffs
            !farCell.IsUnderwater &&
            nearCell.GetEdgeType(farCell) !=
            HexEdgeType.Cliff)
        {
    ...
    //For dealing with gaps in the corner of walls
    public void AddWall(
    ...
    //Creates a single segment, based on the four vertices at the corners of an edge.
    void AddWallSegment(
