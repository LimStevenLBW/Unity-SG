 ...
 */
public class DropKickSkill : Skill
{
    float staminaResult;
    private AudioClip hitSFX;
    UnitController enemyTarget;

    public DropKickSkill()
    {
        maxRange = 1;
        minRange = 1;
        ...
        skillName = "Drop Kick";
        description = "A heavy attack thrown with audacity";
    ...
    public override void DoSkill()
    {
        ...
        controller.PlayAnim("isHeavyAttacking", .45f, this, enemyTarget.Location);
    }
    ...
    public void CalculateDamage(UnitDataStore thisGuy, UnitDataStore enemy)
    {
        ...
        float upperBound = (thisGuy.GetMaxTroopCount() / 5);
        ...
        { //Successful crit
            ...
            DamageGenerator.gen.CreatePopup(position, damageData.ToString() + "!", Color.red, 7);
        }
        else
        { //Run normally

            enemy.SetCurrentTroopCount(enemy.GetCurrentTroopCount() - damageData);
            DamageGenerator.gen.CreatePopup(position, damageData.ToString(), color, 7);
        }
